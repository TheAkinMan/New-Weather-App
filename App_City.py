...
def weather_dashboard():
    return render_template('home_City.html')
...
def get_weather_results(city_name, api_key):
    ...
    #api_url = "http://api.openweathermap.org/data/2.5/weather?zip={}&units=imperial&appid={}".format(city_name, api_key)
...
print(get_weather_results("Houston", get_api_key()))
